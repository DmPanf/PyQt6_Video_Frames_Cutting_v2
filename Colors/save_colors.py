...
import matplotlib
matplotlib.use('Agg')  # Используйте Agg backend для создания файлов
...
def show_color_palette(base_color, factors, filename='color_palette.png'):
    ...
    plt.ylim(-0.5, 1)
    plt.axis('off')
    plt.savefig(filename)  # Сохраняет изображение в файл
    plt.close()
